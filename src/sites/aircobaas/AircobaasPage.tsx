...
export default function AircobaasPage() {
  return (
    <>
      <Hero
        kop="Airco laten plaatsen binnen 2 weken"
        subkop="Koelen én verwarmen. Vakkundige installatie door gecertificeerde monteurs in Midden-Nederland."
        ...
        items={[
          {
            ...
            antwoord:
              "Meestal binnen 2 weken na akkoord op de offerte.",
          },
          {
          ...
          {
            vraag: "Heb ik een vergunning nodig voor een airco?",
            antwoord:
